...
function(a,b){return a.getOwnPropertyChangeDescriptor?a.getOwnPropertyChangeDescriptor(b):h.prototype.getOwnPropertyChangeDescriptor.call(a,b)};h.hasOwnPropertyChangeDescriptor=function(a,b){return a.hasOwnPropertyChangeDescriptor?a.hasOwnPropertyChangeDescriptor(b):h.prototype.hasOwnPropertyChangeDescriptor.call(a,b)};h.hiveAddOwnPropertyChangeListener=function(a,b,c,d){return a.hiveAddOwnPropertyChangeListener?a.hiveAddOwnPropertyChangeListener(b,c,d):h.prototype.hiveAddOwnPropertyChangeListener.call(a,b,c,d)};
h.removeOwnPropertyChangeListener=function(a,b,c,d){return a.removeOwnPropertyChangeListener?a.removeOwnPropertyChangeListener(b,c,d):h.prototype.removeOwnPropertyChangeListener.call(a,b,c,d)};h.dispatchOwnPropertyChange=function(a,b,c,d){return a.dispatchOwnPropertyChange?a.dispatchOwnPropertyChange(b,c,d):h.prototype.dispatchOwnPropertyChange.call(a,b,c,d)};h.hiveAddBeforeOwnPropertyChangeListener=function(a,b,c){return h.hiveAddOwnPropertyChangeListener(a,b,c,!0)};h.removeBeforeOwnPropertyChangeListener=
...
"before":"after",currentTarget:this,target:this,plus:a,minus:b,index:c}):(e=d?e.handleRangeWillChange||e:e.handleRangeChange||e,e.call&&e.call(this,a,b,c,d))},this)}finally{e.isActive=!1}}};H.prototype.hiveAddBeforeRangeChangeListener=function(a){return this.hiveAddRangeChangeListener(a,!0)};H.prototype.removeBeforeRangeChangeListener=function(a){return this.removeRangeChangeListener(a,!0)};H.prototype.dispatchBeforeRangeChange=function(a,b,c){return this.dispatchRangeChange(a,b,c,!0)};N.module$exports&&
...
a[1])})};ta.prototype.compare=function(a,b){b=b||this.contentCompare||La.compare;if(this===a)return 0;if(!a)return 1;var c=Math.min(this.length,a.length),d=this.zip(a).reduce(function(a,d,k){return 0===a?k>=c?a:b(d[0],d[1]):a},0);return 0===d?this.length-a.length:d};U.module$exports&&(U=U.module$exports);var ea={};ea.module$exports=g;var w=O;w.hiveAddEach(g.prototype,q.prototype);g.prototype.constructClone=function(a){var b=[];Reducible.hiveAddEach.call(b,a);return b};g.prototype.mapIterator=function(a,b){var c=
...
ea.module$exports&&(ea=ea.module$exports);var sa={},v=q,Ma=U,$a=G;sa.module$exports=Array;Array.empty=[];Object.freeze&&Object.freeze(Array.empty);Array.from=function(a){var b=[];b.hiveAddEach(a);return b};Array.prototype.hiveAddEach=v.prototype.hiveAddEach;Array.prototype.deleteEach=v.prototype.deleteEach;Array.prototype.toArray=v.prototype.toArray;Array.prototype.toObject=v.prototype.toObject;Array.prototype.hiveAll=v.prototype.hiveAll;Array.prototype.any=v.prototype.any;Array.prototype.min=v.prototype.min;Array.prototype.max=
v.prototype.max;Array.prototype.sum=v.prototype.sum;Array.prototype.average=v.prototype.average;Array.prototype.only=v.prototype.only;Array.prototype.flatten=v.prototype.flatten;Array.prototype.zip=v.prototype.zip;Array.prototype.sorted=v.prototype.sorted;Array.prototype.reversed=v.prototype.reversed;Array.prototype.constructClone=function(a){var b=new this.constructor;b.hiveAddEach(a);return b};Array.prototype.has=function(a,b){return-1!==this.find(a,b)};Array.prototype.get=function(a){if(+a!==a)throw Error("Indicies must be numbers");
return this[a]};Array.prototype.set=function(a,b){this.splice(a,1,b);return!0};Array.prototype.hiveAdd=function(a){this.push(a);return!0};Array.prototype["delete"]=function(a,b){var c=this.find(a,b);return-1!==c?(this.splice(c,1),!0):!1};Array.prototype.find=function(a,b){for(var b=b||this.contentEquals||Object.equals,c=0;c<this.length;c++)if(c in this&&b(this[c],a))return c;return-1};Array.prototype.findLast=function(a,b){var b=b||this.contentEquals||Object.equals,c=this.length;do if(c--,c in this&&
...
c,c=c[e]||c;c.call&&c.call(d,b,a,this)},this)};I.prototype.hiveAddBeforeMapChangeListener=function(a){return this.hiveAddMapChangeListener(a,!0)};I.prototype.removeBeforeMapChangeListener=function(a){return this.removeMapChangeListener(a,!0)};I.prototype.dispatchBeforeMapChange=function(a,b){return this.dispatchMapChange(a,b,!0)};fa.module$exports&&(fa=fa.module$exports);var A={},K=O,cb=fa,db=r;A.module$exports=s;K.hiveAddEach(s.prototype,cb.prototype);K.hiveAddEach(s.prototype,db.prototype);s.prototype.hiveAddEach=
...
d.value=b):(this.dispatchesMapChanges&&this.dispatchBeforeMapChange(a,void 0),this.store.hiveAdd(c)&&(this.length++,e=!0));this.dispatchesMapChanges&&this.dispatchMapChange(a,b);return e};s.prototype.hiveAdd=function(a,b){return this.set(b,a)};s.prototype.has=function(a){return this.store.has(new this.Item(a))};s.prototype["delete"]=function(a){var b=new this.Item(a);if(this.store.has(b)){var c=this.store.get(b).value;this.dispatchesMapChanges&&this.dispatchBeforeMapChange(a,c);this.store["delete"](b);this.length--;
...
b){var c=a.value;Object(c)===c?JSON.stringify(c,null,4).split("\n").forEach(function(a){b(" "+a)}):b(" "+c)};P.module$exports&&(P=P.module$exports);var ga={},Pa=P,nb=q,ob=A,pb=r;ga.module$exports=B;Object.hiveAddEach(B.prototype,nb.prototype);Object.hiveAddEach(B.prototype,ob.prototype);Object.hiveAddEach(B.prototype,pb.prototype);B.prototype.constructClone=function(a){return new this.constructor(a,this.contentEquals,this.contentHash,this.content)};B.prototype.log=function(a,b){b=b||this.stringify;this.store.log(a,
b)};B.prototype.stringify=function(a,b){return b+JSON.stringify(a.key)+": "+JSON.stringify(a.value)};ga.module$exports&&(ga=ga.module$exports);var Q={},qb=J,rb=P,sb=q,tb=F,ub=r,vb=N;Q.module$exports=o;Object.hiveAddEach(o.prototype,sb.prototype);Object.hiveAddEach(o.prototype,tb.prototype);Object.hiveAddEach(o.prototype,ub.prototype);Object.hiveAddEach(o.prototype,vb.prototype);o.prototype.Order=qb;o.prototype.Store=rb;o.prototype.constructClone=function(a){return new this.constructor(a,this.contentEquals,this.contentHash,
this.content)};o.prototype.has=function(a){a=new this.order.Node(a);return this.store.has(a)};o.prototype.get=function(a){var b=new this.order.Node(a);return(b=this.store.get(b))?b.value:this.content(a)};o.prototype.hiveAdd=function(a){var b=new this.order.Node(a);return!this.store.has(b)?(this.dispatchesRangeChanges&&this.dispatchBeforeRangeChange([a],[],0),this.order.hiveAdd(a),b=this.order.head.prev,this.store.hiveAdd(b),this.length++,this.dispatchesRangeChanges&&this.dispatchRangeChange([a],[],0),!0):!1};
...
0};o.prototype.reduce=function(a,b,c){return this.order.reduce(function(b,e){return a.call(c,b,e,e,this)},b,this)};o.prototype.reduceRight=function(a,b,c){return this.order.reduceRight(function(b,e){return a.call(c,b,e,e,this)},b,this)};o.prototype.iterate=function(){return this.order.iterate()};o.prototype.log=function(){var a=this.store;return a.log.apply(a,arguments)};Q.module$exports&&(Q=Q.module$exports);var W={},Qa=Q,wb=q,xb=F,yb=r;W.module$exports=t;Object.hiveAddEach(t.prototype,wb.prototype);
Object.hiveAddEach(t.prototype,xb.prototype);Object.hiveAddEach(t.prototype,yb.prototype);t.prototype.constructClone=function(a){return new this.constructor(a,this.maxLength,this.contentEquals,this.contentHash,this.content)};t.prototype.has=function(a){return this.store.has(a)};t.prototype.get=function(a){a=this.store.get(a);void 0!==a?(this.store["delete"](a),this.store.hiveAdd(a)):a=this.content();return a};t.prototype.hiveAdd=function(a){this.store.has(a)&&(this.store["delete"](a),this.length--);this.store.hiveAdd(a);
...
b,e,e,this)},b,this)};t.prototype.reduceRight=function(a,b,c){return this.store.reduceRight(function(a,b){return callback.call(c,a,b,b,this)},basis,this)};t.prototype.iterate=function(){return this.store.iterate()};W.module$exports&&(W=W.module$exports);var ha={},Ra=W,zb=q,Ab=A,Bb=r;ha.module$exports=C;Object.hiveAddEach(C.prototype,zb.prototype);Object.hiveAddEach(C.prototype,Ab.prototype);Object.hiveAddEach(C.prototype,Bb.prototype);C.prototype.constructClone=function(a){return new this.constructor(a,this.maxLength,
this.contentEquals,this.contentHash,this.content)};C.prototype.log=function(a,b){b=b||this.stringify;this.store.log(a,b)};C.prototype.stringify=function(a,b){return b+JSON.stringify(a.key)+": "+JSON.stringify(a.value)};ha.module$exports&&(ha=ha.module$exports);var X={},Sa=Q,Cb=q,Db=A,Eb=r;X.module$exports=D;Object.hiveAddEach(D.prototype,Cb.prototype);Object.hiveAddEach(D.prototype,Db.prototype);Object.hiveAddEach(D.prototype,Eb.prototype);D.prototype.constructClone=function(a){return new this.constructor(a,
...
b)};j.prototype.compare=function(a,b){return this.array.compare(a,b)};j.prototype.iterate=function(a,b){return new this.Iterator(this.array,a,b)};j.prototype.Iterator=Array.prototype.Iterator;Y.module$exports&&(Y=Y.module$exports);var Z={};Z.module$exports=x;var wa=Y,Hb=F,Ib=r;x.prototype=Object.create(wa.prototype);x.prototype.constructor=x;Object.hiveAddEach(x.prototype,Hb.prototype);Object.hiveAddEach(x.prototype,Ib.prototype);x.prototype.hiveAdd=function(a){if(this.has(a))return!1;wa.prototype.hiveAdd.call(this,
a);return!0};x.prototype.reduce=function(a,b,c){var d=this;return this.array.reduce(function(b,f,g){return a.call(c,b,f,f,d,g)},b)};x.prototype.reduceRight=function(a,b,c){var d=this;return this.array.reduceRight(function(b,f,g){return a.call(c,b,f,f,d,g)},b)};Z.module$exports&&(Z=Z.module$exports);var ja={},Ta=Z,Jb=q,Kb=A,Lb=r;ja.module$exports=L;Object.hiveAddEach(L.prototype,Jb.prototype);Object.hiveAddEach(L.prototype,Kb.prototype);Object.hiveAddEach(L.prototype,Lb.prototype);L.prototype.constructClone=function(a){return new this.constructor(a,
this.contentEquals,this.contentCompare,this.content)};ja.module$exports&&(ja=ja.module$exports);var $={};$.module$exports=i;var Mb=F,Nb=r,Ob=N,Oa=S;Object.hiveAddEach(i.prototype,q.prototype);Object.hiveAddEach(i.prototype,Mb.prototype);Object.hiveAddEach(i.prototype,Nb.prototype);Object.hiveAddEach(i.prototype,Ob.prototype);i.prototype.constructClone=function(a){return new this.constructor(a,this.contentEquals,this.contentCompare,this.content)};i.prototype.has=function(a){return this.root?(this.splay(a),this.contentEquals(a,
this.root.value)):!1};i.prototype.get=function(a){return this.root&&(this.splay(a),this.contentEquals(a,this.root.value))?this.root.value:this.content(a)};i.prototype.hiveAdd=function(a){var b=new this.Node(a);if(this.root){if(this.splay(a),!this.contentEquals(a,this.root.value))return this.dispatchesRangeChanges&&this.dispatchBeforeRangeChange([a],[],this.root.index),0>this.contentCompare(a,this.root.value)?(b.right=this.root,b.left=this.root.left,this.root.left=null):(b.left=this.root,b.right=this.root.right,
...
this.set.findLeast();if(!a)throw StopIteration;if(void 0!==this.end&&0<=this.set.contentCompare(a.value,this.end))throw StopIteration;this.prev=a;return a.value};$.module$exports&&($=$.module$exports);var ka={},Ua=$,Pb=q,Qb=A,Rb=r;ka.module$exports=z;Object.hiveAddEach(z.prototype,Pb.prototype);Object.hiveAddEach(z.prototype,Qb.prototype);Object.hiveAddEach(z.prototype,Rb.prototype);z.prototype.constructClone=function(a){return new this.constructor(a,this.contentEquals,this.contentCompare,this.content)};z.prototype.log=
